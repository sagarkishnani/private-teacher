...
public class RegistroStudentController {
    ...
    static {
        ...
        public String alumno(Model model) {
            model.addAttribute("student", new Usuario());
        ...
        @PostMapping
        public String crear(Usuario student, BindingResult bindingResult, RedirectAttributes ra, Model model) {
...
*/
            ...
            student.setRol(Usuario.Rol.ESTUDIANTE);
